...
*        método: $metodo.POST o $metodo.GET
* tipoRespuesta: $tipo.TEXTO, $tipo.JSON o $tipo.XML
*    parámetros: un string en formato URL o un objeto Hash
*         cache: true o false
...
*                Esta función recibirá el Texto, JSON, XML recibido y el id de la petición
*/

function $Ajax(url, opciones) {
	
	// Preguntamos si no requiere caché
...
function __$AjaxRecibir(opciones, xhr) {
	...
	// Si se ejecuta ese método estamos seguros de que
...
/**
* Función interna que se encarga de entregar un parámetro opcionales
